...
const BG_PASS_FIELDS: FieldDef[] = [
  ...
  { name: 'u_lightCount', type: 'i32' },
  { name: 'u_colorBleedIntensity', type: 'f32' },
  { name: '_pad1', type: 'f32' },
  { name: 'u_shapes', type: 'array_vec4f', count: 8 },
  { name: 'u_shapeParams', type: 'array_vec4f', count: 8 },
  { name: 'u_lights', type: 'array_vec4f', count: 3 },
  { name: 'u_lightColors', type: 'array_vec4f', count: 3 },
];
...
const MAIN_PASS_FIELDS: FieldDef[] = [
  ...
  // Phase 2: Lighting
  { name: 'u_lightCount', type: 'i32' },
  { name: 'u_specularPower', type: 'f32' },
  { name: 'u_specularIntensity', type: 'f32' },
  { name: 'u_causticsEnabled', type: 'i32' },
  { name: 'u_causticsScale', type: 'f32' },
  { name: 'u_causticsIntensity', type: 'f32' },
  { name: 'u_bevelWidth', type: 'f32' },
  { name: 'u_edgeGlowIntensity', type: 'f32' },
  { name: '_pad_lighting', type: 'f32' },
  { name: '_pad_lighting2', type: 'f32' },
  { name: '_pad_lighting3', type: 'f32' },
  { name: 'u_edgeGlowColor', type: 'vec3f' },
  { name: 'u_colorBleedIntensity', type: 'f32' },
  { name: 'u_lights', type: 'array_vec4f', count: 3 },
  { name: 'u_lightColors', type: 'array_vec4f', count: 3 },
  // Phase 3: Material Realism
  { name: 'u_roughness', type: 'f32' },
  { name: 'u_reflectionIntensity', type: 'f32' },
  { name: 'u_glassOnGlass', type: 'i32' },
  { name: 'u_dofIntensity', type: 'f32' },
  { name: 'u_frostedEdge', type: 'f32' },
  { name: 'u_sellmeierEnabled', type: 'i32' },
  { name: 'u_sellmeierB', type: 'vec3f' },
  { name: '_pad_sellB', type: 'f32' },
  { name: 'u_sellmeierC', type: 'vec3f' },
  { name: '_pad_sellC', type: 'f32' },
  { name: 'u_multiBounce', type: 'i32' },
  { name: '_pad_phase3', type: 'i32' },
  // Phase 4: Surface Detail
  { name: 'u_smudgeEnabled', type: 'i32' },
  { name: 'u_smudgeIntensity', type: 'f32' },
  { name: 'u_scratchEnabled', type: 'i32' },
  { name: 'u_scratchDensity', type: 'f32' },
  { name: 'u_scratchDepth', type: 'f32' },
  { name: 'u_scratchAngle', type: 'f32' },
  { name: 'u_bubbleEnabled', type: 'i32' },
  { name: 'u_bubbleCount', type: 'i32' },
  { name: 'u_bubbleSeed', type: 'f32' },
  { name: 'u_bubbleSize', type: 'f32' },
  { name: 'u_dustEnabled', type: 'i32' },
  { name: 'u_dustDensity', type: 'f32' },
  { name: 'u_dustBrightness', type: 'f32' },
  { name: '_pad_phase4', type: 'f32' },
  // Phase 5: Motion & Polish
  { name: 'u_flowEnabled', type: 'i32' },
  { name: 'u_flowSpeed', type: 'f32' },
  { name: 'u_flowScale', type: 'f32' },
  { name: 'u_flowIntensity', type: 'f32' },
  { name: 'u_pulseEnabled', type: 'i32' },
  { name: 'u_pulseAmplitude', type: 'f32' },
  { name: 'u_pulseFrequency', type: 'f32' },
  { name: '_pad_phase5', type: 'f32' },
];
